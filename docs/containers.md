...
briefed from. Six exist so far — the universe manifest ([universe-form.md](universe-form.md)),
[fauna](fields-fauna.md), [locations](fields-locations.md), [people](fields-people.md),
[history](fields-history.md) and [afflictions](fields-afflictions.md). A container without one is not broken; its entries are the name, summary
