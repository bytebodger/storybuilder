...
briefed from. Sixteen exist so far — the universe manifest ([universe-form.md](universe-form.md)),
...
[languages](fields-languages.md), [legends](fields-legends.md), [phenomena](fields-phenomena.md) and
[roads](fields-roads.md). A container without one is not broken; its entries are the name, summary
