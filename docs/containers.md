...
briefed from. Fifteen exist so far — the universe manifest ([universe-form.md](universe-form.md)),
...
[languages](fields-languages.md), [legends](fields-legends.md) and
[phenomena](fields-phenomena.md). A container without one is not broken; its entries are the name, summary
