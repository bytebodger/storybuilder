...
briefed from. Eight exist so far — the universe manifest ([universe-form.md](universe-form.md)),
...
and [documents](fields-documents.md). A container without one is not broken; its entries are the name, summary
