...
briefed from. Twelve exist so far — the universe manifest ([universe-form.md](universe-form.md)),
...
[geography](fields-geography.md) and [institutions](fields-institutions.md). A container without one is not broken; its entries are the name, summary
