...
- [x] Generic field specs: one form, one generator, any container. The universe manifest and all twenty containers in the catalog have one. See [docs/containers.md](docs/containers.md#fields)
...
- [x] Field specs for every container in the catalog
