...
- [x] Generic field specs: one form, one generator, any container. `universe`, `fauna`, `locations`, `people`, `history`, `afflictions`, `cosmology`, `documents` and `ethnicities` have specs
...
- [ ] Field specs for the remaining eleven containers
