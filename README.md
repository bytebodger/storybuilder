...
- [x] Generic field specs: one form, one generator, any container. `universe`, `fauna`, `locations`, `people`, `history`, `afflictions`, `cosmology`, `documents`, `ethnicities`, `flora`, `geography`, `institutions`, `languages`, `legends`, `phenomena`, `roads` and `tales` have specs
...
- [ ] Field specs for the remaining three containers
