...
- [x] Generic field specs: one form, one generator, any container. `universe`, `fauna`, `locations`, `people`, `history`, `afflictions`, `cosmology`, `documents`, `ethnicities`, `flora`, `geography`, `institutions` and `languages` have specs
...
- [ ] Field specs for the remaining seven containers
