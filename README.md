...
- [x] Generic field specs: one form, one generator, any container. `universe`, `fauna`, `locations`, `people`, `history`, `afflictions`, `cosmology`, `documents`, `ethnicities`, `flora`, `geography`, `institutions`, `languages`, `legends`, `phenomena`, `roads`, `tales`, `terminology` and `theology` have specs
...
- [ ] The remaining skills: `outline`, `scene-draft`, `continuity-pass`, `world-brief`
...
- [ ] Field specs for the remaining container (`traditions`)
